...
-- -----------------------------------------------------
-- Table `equipment_service_reference`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `equipment_service_reference` ;

CREATE TABLE IF NOT EXISTS `equipment_service_reference` (
...
-- -----------------------------------------------------
-- Data for table `equipment_service_reference`
-- -----------------------------------------------------
START TRANSACTION;
USE `equipmentservicedb`;
INSERT INTO `equipment_service_reference` (`id`, `equipment_name`, `equipment_manufacturer`, `equipment_model`, `equipment_serial_number`, `engine_manufacturer`, `engine_model`, `engine_serial_number`, `engine_oil_manufacturer`, `engine_oil_type`, `engine_oil_viscosity_grade`, `engine_oil_filter_manufacturer`, `engine_oil_filer_part_number`, `engine_air_filter_manufacturer`, `engine_air_filter_part_number`, `egnine_fuel_specifications`, `engine_fuel_filter_manufacturer`, `engine_fuel_filter_part_number`, `engine_fuel_oil`, `engine_fuel_oil_manufacturer`, `engine_fuel_oil_name`, `engine_fuel_oil_serial_number`, `equipment_consumable_name`, `equipment_consumable_manufacturer`, `equipment_consumable_part_number`, `equipment_consumable_name_2`, `equipment_consumable_manufacturer_2`, `equipment_consumable_part_number_2`, `equipment_consumable_name_3`, `equipment_consumable_manufacturer_3`, `equipment_consumable_part_number_3`, `equipment_notes`) VALUES (1, 'Chainsaw', 'Stihl', 'MS171', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
